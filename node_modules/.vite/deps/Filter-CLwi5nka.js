import { A as DOMAdapter, B as Bounds, G as TextureStyle, L as GlobalResourceRegistry, M as InstructionSet, N as multiplyHexColors, P as BigPool, Q as v8_0_0, R as warn, V as Texture, W as TextureSource, Y as nextPow2, Z as deprecation, at as Point, ct as RAD_TO_DEG, dt as extensions, it as Matrix, lt as eventemitter3_default, o as Shader, ot as DEG_TO_RAD, p as GpuProgram, tt as uid, ut as ExtensionType, x as GlProgram, z as Color } from "./Geometry-DpgSrUJG.js";
...
var _Ticker = class _Ticker {
	...
	*/
	...
	set minFPS(fps) {
		this._maxElapsedMS = 1 / Math.min(Math.max(0, fps) / 1e3, _Ticker.targetFPMS);
...
var _Filter = class _Filter extends Shader {
	/**
...
var Filter = _Filter;
//#endregion
export { boundsPool as A, cacheAsTextureMixin as B, getLocalBounds as C, getGlobalBounds as D, multiplyColors as E, MaskEffectManagerClass as F, updateQuadBounds as H, FilterEffect as I, collectRenderablesMixin as L, findMixin as M, effectsMixin as N, updateTransformBackwards as O, MaskEffectManager as P, childrenHelperMixin as R, checkChildrenDidChange as S, getGlobalMixin as T, ObservablePoint as U, cullingMixin as V, TexturePoolClass as _, UPDATE_PRIORITY as a, onRenderMixin as b, ViewContainer as c, UPDATE_COLOR as d, UPDATE_TRANSFORM as f, TexturePool as g, RenderGroup as h, TickerListener as i, matrixPool as j, getFastGlobalBoundsMixin as k, Container as l, assignWithIgnore as m, State as n, CanvasSource as o, UPDATE_VISIBLE as p, Ticker as r, Sprite as s, Filter as t, UPDATE_BLEND as u, toLocalGlobalMixin as v, bgr2rgb as w, measureMixin as x, sortMixin as y, removeItems as z };

//# sourceMappingURL=Filter-CLwi5nka.js.map