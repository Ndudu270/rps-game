...
var _TextureStyle = class _TextureStyle extends eventemitter3_default {
	...
	*/
	...
	_generateResourceId() {
		this._sharedResourceId = createResourceIdFromString(`${this.addressModeU}-${this.addressModeV}-${this.addressModeW}-${this.magFilter}-${this.minFilter}-${this.mipmapFilter}-${this.lodMinClamp}-${this.lodMaxClamp}-${this.compare}-${this._maxAnisotropy}`);
...
var GpuProgram = class GpuProgram {
	...
	*/
	constructor(options) {
		...
		else this.structsAndGroups = removeStructAndGroupDuplicates(extractStructAndGroups(vertex.source), extractStructAndGroups(fragment.source));
	...
	_generateProgramKey() {
		...
		this._layoutKey = createIdFromString(vertex.source + fragment.source + vertex.entryPoint + fragment.entryPoint, "program");
	}
	get attributeData() {
...
//#endregion
export { v8_3_4 as $, DOMAdapter as A, Bounds as B, setProgramName as C, getMaxFragmentPrecision as D, addProgramDefines as E, PoolGroupClass as F, TextureStyle as G, TextureMatrix as H, Pool as I, log2 as J, definedProps as K, GlobalResourceRegistry as L, InstructionSet as M, multiplyHexColors as N, getTestContext as O, BigPool as P, v8_0_0 as Q, warn as R, stripVersion as S, ensurePrecision as T, BufferImageSource as U, Texture as V, TextureSource as W, NOOP as X, nextPow2 as Y, deprecation as Z, ShaderStage as _, BufferUsage as a, Point as at, getAttributeInfoFromFormat as b, BindGroup as c, RAD_TO_DEG as ct, UNIFORM_TYPES_MAP as d, extensions as dt, resetUids as et, UNIFORM_TYPES_VALUES as f, normalizeExtensionPriority as ft, generateGpuLayoutGroups as g, generateLayoutHash as h, Buffer$1 as i, Matrix as it, BrowserAdapter as j, createIdFromString as k, UniformGroup as l, eventemitter3_default as lt, removeStructAndGroupDuplicates as m, __toESM as mt, getGeometryBounds as n, Rectangle as nt, Shader as o, DEG_TO_RAD as ot, GpuProgram as p, __commonJSMin as pt, isPow2 as q, ensureIsBuffer as r, groupD8 as rt, RendererType as s, PI_2 as st, Geometry as t, uid as tt, getDefaultUniformValue as u, ExtensionType as ut, extractStructAndGroups as v, insertVersion as w, GlProgram as x, extractAttributesFromGpuProgram as y, Color as z };

//# sourceMappingURL=Geometry-DpgSrUJG.js.map