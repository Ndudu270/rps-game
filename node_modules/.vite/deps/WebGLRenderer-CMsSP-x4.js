import { A as DOMAdapter, R as warn, V as Texture, W as TextureSource, a as BufferUsage, b as getAttributeInfoFromFormat, dt as extensions, it as Matrix, l as UniformGroup, nt as Rectangle, o as Shader, s as RendererType, t as Geometry, ut as ExtensionType, x as GlProgram } from "./Geometry-DpgSrUJG.js";
import { n as State, o as CanvasSource } from "./Filter-CLwi5nka.js";
import { Y as AbstractRenderer, Z as CLEAR, a as SharedSystems, i as SharedRenderPipes, t as RenderTargetSystem } from "./RenderTargetSystem-BQ-jHc9C.js";
import { F as STENCIL_MODES, M as checkMaxIfStatementsInShader, c as generateTextureBatchBitGl, d as compileHighShaderGlProgram, i as getBatchSamplersUniformGroup, o as roundPixelsBitGl, t as GCManagedHash, u as colorBitGl } from "./GCManagedHash-DapmiZVU.js";
import { a as uniformParsers, c as ensureAttributes, f as localUniformBitGl, i as createUboSyncFunction, n as uboSyncFunctionsSTD40, o as UboSystem, s as GpuStencilModesToPixi, t as BufferResource, u as textureBitGl } from "./BufferResource-CTpVF5wy.js";
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/buffer/GlBuffer.mjs
var GlBuffer = class {
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/buffer/GlBufferSystem.mjs
...
var _GlContextSystem = class _GlContextSystem {
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/const.mjs
...
var bigTriangleGeometry = new Geometry({ attributes: { aPosition: [
	-1,
	-1,
	3,
	-1,
...
var _GlBackBufferSystem = class _GlBackBufferSystem {
	constructor(renderer) {
...
_GlBackBufferSystem.defaultOptions = { useBackBuffer: false };
var GlBackBufferSystem = _GlBackBufferSystem;
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/GlColorMaskSystem.mjs
...
var GlLimitsSystem = class {
	...
	contextChange() {
		...
		this.maxUniformBindings = this._renderer.context.webGLVersion === 2 ? gl.getParameter(gl.MAX_UNIFORM_BUFFER_BINDINGS) : 0;
	}
	destroy() {}
};
/** @ignore */
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/renderTarget/GlRenderTargetSystem.mjs
...
var WINDING = 4;
var DEPTH_MASK = 5;
var _GlStateSystem = class _GlStateSystem {
	constructor(renderer) {
		/**
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/GlTexture.mjs
var GlTexture = class {
	constructor(texture) {
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/uploaders/glUploadBufferImageResource.mjs
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/uploaders/glUploadCompressedTextureResource.mjs
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/pixiToGlMaps.mjs
...
//#endregion
//#region node_modules/pixi.js/lib/rendering/renderers/gl/texture/utils/unpremultiplyAlpha.mjs
function unpremultiplyAlpha(pixels) {
	...
	for (let i = 0; i < n; i += 4) {
		...
		if (alpha !== 0) {
			...
			pixels[i] = pixels[i] * a + .5;
			pixels[i + 1] = pixels[i + 1] * a + .5;
			pixels[i + 2] = pixels[i + 2] * a + .5;
		}
	}
}
//#endregion
...
//#endregion
export { GlGeometryGpuData as $, getUniformData as A, GlRenderTargetSystem as B, GlUniformGroupSystem as C, GlShaderSystem as D, UNIFORM_TO_SINGLE_SETTERS as E, defaultValue as F, WGSL_TO_STD40_SIZE as G, GlUboSystem as H, compileShader as I, GlRenderTarget as J, createUboElementsSTD40 as K, GlProgramData as L, extractAttributesFromGlProgram as M, mapGlToVertexFormat as N, generateProgram as O, mapType as P, GlBackBufferSystem as Q, IGLUniformData as R, mapWebGLBlendModesToPixi as S, UNIFORM_TO_ARRAY_SETTERS as T, createUboSyncFunctionSTD40 as U, GlRenderTargetAdaptor as V, generateArraySyncSTD40 as W, GlEncoderSystem as X, GlLimitsSystem as Y, GlColorMaskSystem as Z, createGlUploadCubeTextureResource as _, unpremultiplyAlpha as a, GL_WRAP_MODES as at, GlTexture as b, mapFormatToGlInternalFormat as c, GlBuffer as ct, compareModeToGlCompare as d, isSafari as dt, GlGeometrySystem as et, mipmapScaleModeToGlFilter as f, glUploadImageResource as g, glUploadVideoResource as h, GlTextureSystem as i, GL_TYPES as it, getUboData as j, logProgramError as k, mapFormatToGlFormat as l, BUFFER_TYPE as lt, wrapModeToGlAddress as m, GlMeshAdaptor as n, GL_FORMATS as nt, mapViewDimensionToGlTarget as o, GlContextSystem as ot, scaleModeToGlFilter as p, GlStencilSystem as q, GlGraphicsAdaptor as r, GL_TARGETS as rt, mapFormatToGlType as s, GlBufferSystem as st, WebGLRenderer as t, getGlTypeFromFormat as tt, applyStyleParams as u, GlBatchAdaptor as ut, glUploadCompressedTextureResource as v, generateUniformsSync as w, GlStateSystem as x, glUploadBufferImageResource as y, generateShaderSyncCode as z };

//# sourceMappingURL=WebGLRenderer-CMsSP-x4.js.map