import { A as DOMAdapter, B as Bounds, R as warn, U as BufferImageSource, V as Texture, W as TextureSource, c as BindGroup, dt as extensions, it as Matrix, l as UniformGroup, nt as Rectangle, p as GpuProgram, s as RendererType, t as Geometry, ut as ExtensionType, x as GlProgram } from "./Geometry-DpgSrUJG.js";
import { A as boundsPool, C as getLocalBounds, D as getGlobalBounds, g as TexturePool, j as matrixPool, l as Container, o as CanvasSource, r as Ticker, s as Sprite, t as Filter } from "./Filter-CLwi5nka.js";
...
function addMaskLocalBounds(mask, bounds, localRoot) {
	...
	getLocalBounds(mask, boundsToMask, getMatrixRelativeToParent(mask, localRoot, tempMatrix));
	mask.measurable = false;
	bounds.addBoundsMask(boundsToMask);
...
var _VideoSource = class _VideoSource extends TextureSource {
	constructor(options) {
		super(options);
...
//#endregion
//#region node_modules/pixi.js/lib/spritesheet/Spritesheet.mjs
var _Spritesheet = class _Spritesheet {
...
//#endregion
//#region node_modules/pixi.js/lib/filters/defaults/passthrough/passthrough.frag.mjs
var fragment = "in vec2 vTextureCoord;\nout vec4 finalColor;\nuniform sampler2D uTexture;\nvoid main() {\n    finalColor = texture(uTexture, vTextureCoord);\n}\n";
//#endregion
//#region node_modules/pixi.js/lib/filters/defaults/passthrough/passthrough.wgsl.mjs
...
//#endregion
//#region node_modules/pixi.js/lib/filters/defaults/passthrough/PassthroughFilter.mjs
...
function getGlobalRenderableBounds(renderables, bounds) {
	...
	for (let i = 0; i < renderables.length; i++) {
		...
		if (renderGroup?.isCachedAsTexture) bounds.matrix = tempProjectionMatrix.copyFrom(renderGroup.textureOffsetInverseTransform).append(renderable.worldTransform);
		else if (renderGroup?._parentCacheAsTextureRenderGroup) bounds.matrix = tempProjectionMatrix.copyFrom(renderGroup._parentCacheAsTextureRenderGroup.inverseWorldTransform).append(renderable.groupTransform);
		else bounds.matrix = renderable.worldTransform;
...
var FilterSystem = class {
	...
	*/
	generateFilteredTexture({ texture, filters }) {
		...
		this._calculateGlobalFrame(filterData, 0, 0, globalResolution, colorTextureSource.width, colorTextureSource.height);
	...
	pop() {
		...
		if (filterData.blendRequired) TexturePool.returnTexture(filterData.backTexture);
	...
	*/
	_setupFilterTextures(filterData, bounds, renderer, previousFilterData) {
		...
		renderer.globalUniforms.push({ offset: bounds });
	}
	/**
	...
	*/
	_updateFilterUniforms(input, output, filterData, offsetX, offsetY, resolution, isFinalTarget, clear) {
		...
		inputClamp[2] = input.frame.width * inputSize[2] - .5 * inputPixel[2];
		inputClamp[3] = input.frame.height * inputSize[3] - .5 * inputPixel[3];
	...
	*/
	...
	_applyFiltersToTexture(filterData, clear) {
		...
		if (firstEnabled === lastEnabled) filters[firstEnabled].apply(this, inputTexture, filterData.outputRenderSurface, clear);
		else {
	...
	_pushFilterData() {
		...
		if (!filterData) filterData = this._filterStack[this._filterStackIndex] = new FilterData();
		this._filterStackIndex++;
		return filterData;
	}
};
...
//#endregion
export { ColorMask as C, addMaskBounds as E, StencilMask as S, addMaskLocalBounds as T, autoDetectSource as _, source as a, VideoSource as b, spritesheetAsset as c, Resolver as d, getUrlExtension as f, LoaderParserPriority as g, path as h, PassthroughFilter as i, Spritesheet as l, createStringVariations as m, getGlobalRenderableBounds as n, fragment as o, isSingleItem as p, FilterPipe as r, vertex as s, FilterSystem as t, copySearchParams as u, resourceToTexture as v, AlphaMask as w, detectVideoAlphaMode as x, textureFrom as y };

//# sourceMappingURL=FilterSystem-D80qCE1k.js.map